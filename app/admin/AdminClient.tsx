...
// `initial` viene del Server Component (app/admin/page.tsx). cargar() se
// mantiene para refrescar después de agregar/quitar un admin.
export default function AdminClient({ initial }: { initial: RoleRow[] | null }) {
  ...
  useEffect(() => { if (initial === null) cargar() }, [initial])
